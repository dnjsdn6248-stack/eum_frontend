...
export default function Toast({ message, onClose, onNavigate, navText = '바로가기' }) {
  useEffect(() => {
  ...
  return (
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[999] animate-in fade-in slide-in-from-bottom-4">
      <div className="flex items-center bg-[#111] text-white px-6 py-4 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.2)] min-w-[320px]">
