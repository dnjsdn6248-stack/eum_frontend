...
```json
{
  ...
  "extra": {
    "weights": { "recency": 1.0 },
    "updatedAt": "2026-04-16 01:48:17"
  },
  "data": [
    {
      "rank": 1,
      "id": 30,
      "imageUrl": "https://eums3bucket.s3.ap-northeast-2.amazonaws.com/product/images/...",
      "productTitle": "오독오독 바삭 덕블연 3종세트",
      "price": 13900,
      "score": 1.0,
      "salesCount": 0,
      "createdAt": "1776243016311",
      "productUrl": "/products/30"
    }
  ]
}
```
...
```json
{
  ...
  "hasNext": false,
  "hasPrevious": false,
  "extra": { "updatedAt": "2026-04-16 11:20:02" },
  "data": [
    { "productId": 185, "imageUrl": "https://.../product-main-185.jpg", "displayOrder": 1, "isHero": true },
    { "productId": 184, "imageUrl": "https://.../product-main-184.jpg", "displayOrder": 2, "isHero": true },
    { "productId": 183, "imageUrl": "https://.../product-main-183.jpg", "displayOrder": 3, "isHero": true }
  ]
}
```
...
- 상세의 "이런 제품은 어때요?" 섹션은 `/api/v1/search/products/{productId}/similar?size=3` 고정 사용 권장
- UI 태그는 `tags[]` 순서를 그대로 렌더링하면 우선순위 정책 (`[NEW]` 먼저 → 판매 순위) 이 자동 반영됨
- 인증은 게이트웨이 정책을 따르며, 보호 경로에서는 `Authorization` 헤더가 필요할 수 있음
